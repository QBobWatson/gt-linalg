...
(function() {
  ...
  Controller = (function() {
    function Controller(mathbox, opts) {
      ...
      if (opts.refColor == null) {
        opts.refColor = "rgb(80, 120, 255)";
      }
      if (opts.clipCube == null) {
        opts.clipCube = function(x) {
          return {
            clipped: x
          };
        };
      ...
      this.numPointsDep = this.is3D ? opts.numPointsDep : 1;
    ...
    Controller.prototype.install = function(type, opts) {
      var canvas, i, k, params, pointsOpts, pointsType, ref;
      if (opts == null) {
        opts = {};
      }
      ...
      this.matrixOrigCoords = new THREE.Matrix4().multiply(this.coordMat).multiply(this.current.stepMat).multiply(this.coordMatInv);
      ...
      if (this.initialized) {
        ...
        if (this.is3D) {
          pointsOpts.depth = this.numPointsDep;
    ...
    Controller.prototype.randomizeCoords = function() {
      ...
      return this.installCoords(v1, v2);
    };

    Controller.prototype.installCoords = function(v1, v2, v3) {
      var clipCube, cmi, corners, i, k, len1, rad, ref, results;
      this.is3D = v3 != null;
      if (v1[2] == null) {
        v1[2] = 0;
      }
      ...
      if (this.view) {
        return this.view.set('matrix', this.coordMat);
      } else {
        this.viewBase = this.mathbox.cartesian({
          range: [[-1, 1], [-1, 1], [-1, 1]],
          scale: [1, 1, 1]
        });
        clipCube = this.clipCube(this.viewBase);
        this.view0 = clipCube.clipped;
  ...
  Diagonalizable = (function(superClass) {
    ...
    function Diagonalizable(extents, opts) {
      ...
      if (this.swapped) {
        this.makeStepMat(this.λ2, 0, 0, this.λ1);
      } else {
        this.makeStepMat(this.λ1, 0, 0, this.λ2);
      }
    }
